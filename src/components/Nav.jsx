...
const Nav = () => {
  return (
    <nav
      className={
        " position: fixed; md:rounded-lg md:h-[72px] md:gap-x-[32px] flex h-[56px] items-center gap-x-[24px] bg-semi-dark-blue px-4 lg:h-[960px] lg:w-[96px] lg:min-w-[96px] lg:flex-col lg:items-center lg:gap-y-[40px] lg:rounded-2xl lg:pt-[35.41px]"
      }
    >
